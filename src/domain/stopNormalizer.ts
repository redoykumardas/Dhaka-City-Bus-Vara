...
export const ALIASES: Record<string, string[]> = {
  ...
  "Shewrapara": ["শেওড়াপাড়া (Shewrapara)", "শেওড়াপাড়া"],
  "Shewra": ["Shewra", "শেওড়া", "শেওড়া (Shewra)"],
  ...
  "Banani": ["বনানী"],
  "Airport": ["Airport", "বিমানবন্দর", "বিমানবন্দর (Airport)"],
  "Khilkhet": ["খিলক্ষেত"],
  "Kuril Bishwa Road": ["কুড়িল বিশ্ব রোড"],
  "Staff Road": ["Staff Road", "স্টাফ রোড", "স্টাফ রোড (Staff Road)"],
  "Kakali": ["Kakali", "কাকলী", "কাকলী (Kakali)"],
  "Jashimuddin": ["জসিমউদ্দিন"],
  ...
  "Bashtola": ["বাঁশতলা"],
  "Uttara": ["উত্তরা", "Uttara Diabari", "Azampur", "আজমপুর", "House Building", "হাউজ বিল্ডিং", "Jashimuddin", "জসিমউদ্দিন", "Rajlakshmi", "রাজলক্ষ্মী"],
  ...
  "Kanchpur": ["কাঁচপুর"],
  "Sonargaon": ["সোনারগাঁও"],
  "Sainik Club": ["Sainik Club", "সৈনিক ক্লাব", "সৈনিক ক্লাব (Sainik Club)"],
  "Chairman Bari": ["Chairman Bari", "চেয়ারম্যান বাড়ী", "চেয়ারম্যান বাড়ী (Chairman Bari)"],
